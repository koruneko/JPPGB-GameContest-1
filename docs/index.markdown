...
# はじめに
こちらでは **【JPPGB】ゲーム作成コンテスト #1** にてエントリーしていただいた方の作品を公開しています。  
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">
        <a href="https://x.com/flali_world">
          <span style="font-size: 125%">
            <strong>ふらり @ ROBO BOY さん</strong>
          </span>
        </a>
        <br>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <a href="https://github.com/koruneko/JPPGB-GameContest-1/blob/main/99.運営枠/03.コルネ/PowerLabyrinth_1_0_0_4_managed.zip">作品リンク Ver-2.0</a>
        <br>(Solution File)
        <br>
...
# 前回の作品
前回のエントリー作品に興味のある方は [こちらのページ](https://koruneko.github.io/JPPGB-GameContest-0/) から確認することができます。  